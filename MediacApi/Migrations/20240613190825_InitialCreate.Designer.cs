...
namespace MediacApi.Migrations
{
    ...
    [Migration("20240613190825_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediacBack.Data.Entities.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MediacBack.Data.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MediacBack.Data.Entities.Post", b =>
                {
                    b.HasOne("MediacBack.Data.Entities.Blog", "Blog")
                        .WithMany("posts")
